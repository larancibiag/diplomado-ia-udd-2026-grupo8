# **Datasheet — Colección de vinilos**
...
A medida que ingresaba a la colección se hacía el registro del disco

* ¿Cuándo?

Entre Mayo de 2023 y Diciembre 2025
...
Como un asistente personal para catalogar tus vinilos, evitar compras repetidas, recibir sugerencias cuando no sabes qué escuchar y crear resúmenes narrativos de tus hábitos musicales.

* Para qué NO debería usarse:

No sirve para escuchar música, ni debe reemplazar el gusto propio de elegir el vinilo en el tocadiscos, ni para juzgar qué tan buen coleccionista es el usuario según la cantidad de vinilos o ediciones que que comprende la colección.
